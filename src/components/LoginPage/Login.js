    ...
    return (
        <div className="login container my-5">
                ...
                <form onSubmit={handleFormSubmit} >
                    {
                        ...
                        <div className="border d-flex flex-column justify-content-center align-content-center px-5 pt-4 pb-2">
                            ...
                            <input type="submit" className="btn btn-gradient mt-3 fs-5 rounded-pill" value="Create an account" />
                            <p className="mt-3">already have an account <Link className="text-primary fw-bold" onClick={()=>setIsNewUser(false)}>Sign in</Link> </p>    
                        </div>
                        :
                        <div className="border d-flex flex-column justify-content-center align-content-center px-5 pt-4 pb-2">
                            ...
                            <input required type="email" name="email" onBlur={handleBlur} placeholder="Email"/>
                            <input required type="password" name="password" onBlur={handleBlur} placeholder="Password"/>
                            <input type="submit" className="btn btn-gradient mt-3 fs-5" value="Login" />
                            <p className="mt-3">Don't have an account <Link className="text-primary fw-bold" onClick={()=>setIsNewUser(true)}>Signup</Link> </p>    
                        </div>
                    }
                </form>
            </div>
            ...
            <div className="social-account d-flex justify-content-center">
                <button className="btn border rounded-pill fw-bold" onClick={handleGoogleSignIn}><FontAwesomeIcon className="icon me-5 text-primary" icon={faGoogle} />Continue with google</button>
            </div>
        </div>
    );
};
