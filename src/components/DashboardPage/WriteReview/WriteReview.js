...
const WriteReview = () => {
  ...
  const onSubmit = (data) => {
    ...
    fetch('https://digital-agency-server.onrender.com/addReview', {
      method: 'POST',
  ...
  return (
    <div>
      <h2>Write Review</h2>
      <form
        className='customFormStyle mb-5 w-50 mt-5'
      ...
      >
        ...
        <div className='form-group'>
          <textarea
            ...
            rows='6'
            maxlength='100'
            placeholder='Description(max 100words)'
          ></textarea>
          {errors.comment && (
            <span className='text-danger'>This field is required</span>
          )}
        ...
        <div className='d-flex justify-content-between'>
          ...
          <div>
            {formSuccessMessage && (
              <p className='formSubmitMsgStyle'>{formSuccessMessage}</p>
            )}
            {formErrorMessage && (
